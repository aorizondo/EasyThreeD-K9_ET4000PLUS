...
//#define HOME_Z_FIRST                      // Custom ET4000+: OFF. Incompatible con Z homing por sonda (requiere endstop real)
...
//
//#define ASSISTED_TRAMMING   // Custom ET4000+: OFF (con UBL no hace falta nivelar tornillos a mano)
 ...
 */
//#define INPUT_SHAPING_X   // Custom ET4000+: OFF (mas simple; evita el cap de step-rate que limitaria los 600mm/s)
...
#define CALIBRATION_GCODE
  ...
  #define CALIBRATION_FEEDRATE_SLOW           20    // mm/min
  #define CALIBRATION_FEEDRATE_FAST          100    // mm/min
  #define CALIBRATION_FEEDRATE_TRAVEL         50    // mm/min
  ...
  #define CALIBRATION_OBJECT_CENTER     { 10.0, 10.0,  5.0 } // mm
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY   // Custom ET4000+: reanudar impresion tras corte
  #if ENABLED(POWER_LOSS_RECOVERY)
    #define PLR_ENABLED_DEFAULT   true  // Activo por defecto (sin necesidad de M413 S1)
...
#define G38_PROBE_TARGET
  ...
  #define G38_MINIMUM_MOVE 0.005 // (mm) Minimum distance that will produce a move.
#endif
...
#define FWRETRACT
  ...
  #define RETRACT_FEEDRATE             250  // (mm/s) Default feedrate for retracting
  #define RETRACT_ZRAISE                0   // (mm) Default retract Z-raise
  #define RETRACT_RECOVER_LENGTH        0.5 // (mm) Default additional recover length (added to retract length on recover)
  #define RETRACT_RECOVER_LENGTH_SWAP   0.5 // (mm) Default additional swap recover length (added to retract length on recover from toolchange)
...
#define CUSTOM_USER_BUTTONS
  ...
  // Home button (PC3). easythreed_ui.init() mantiene su masa PC2 en LOW.
...
//#define MARLIN_DEV_MODE   // Custom ET4000+: firmware de produccion
